...
export default function StudentDailyAttendancePage() {
    ...
    const reload = () => {
        router.get('/dashboard/attendances/students/daily', { date, class_section_id: sectionId }, { preserveState: true, preserveScroll: true, replace: true });
    };
    ...
    const save = async () => {
        ...
        if (!confirmed) return;
        setSaving(true);
        router.post('/dashboard/attendances/students/daily', {
            date,
    ...
    return (
        <AuthenticatedLayout breadcrumbs={[{ title: 'Dashboard', href: '/dashboard' }, { title: 'Student Daily Attendance', href: '/dashboard/attendances/students/daily' }]}>
            <Head title="Student Daily Attendance" />
            <div className="p-6 space-y-4">
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Button onClick={save} disabled={saving || !sectionId}>{saving ? 'Saving...' : 'Save'}</Button>
                </div>
